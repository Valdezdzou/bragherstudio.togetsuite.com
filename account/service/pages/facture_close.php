<?php 
	...
	if (isLogged() == 0) {
        ...
        $total_total_factures_close=$query->rowCount();
	}
?>
    ...
    <body class="bg-white">
        ...
        <div id="appCapsule">
            ...
            <ul class="listview image-listview media mb-2">
                ...
                <?php
                    $sqlSelect = "SELECT DISTINCT fa_client,fa_code,fa_phone, SUM(pr_prix_vente*fa_quantite) AS prix FROM tsb_factures WHERE fa_status='Close' GROUP BY fa_client,fa_code,fa_phone";
                    ...
                    <div class="item">
                        <div class="in">
                            <div>
                                ...
                                <p class="text-muted">
                                    <?php  echo $row['prix']; ?> XAF, <?php  echo $row['fa_code']; ?>
                                </p>
                            </div>
