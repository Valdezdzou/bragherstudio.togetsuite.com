                ...
                <div class="tab-pane fade show active" id="photos" role="tabpanel">
                    ...
                    <div class="section full mt-1">
                        ...
                        <ul class="listview image-listview">
                                    ...
                                    <div class="item">
                                        <div class="in">
                                            <div>
                                                ...
                                                <input type="hidden"  name="pr_designation_close"  value="<?php  echo $row_facture['pr_designation']; ?>">
                                            </div>
                                            <span class="badge">
                                                <input readonly type="number" style="width: 40px; text-align:right" value="<?php  echo $row_facture['prix_total_vente']; ?>">
                                                <input readonly type="number" style="width: 40px; text-align:right" value="<?php  echo $row_facture['quantite_total_vente']; ?>">
                                            </span>
                                        </div>
                                    </div>
                                </li>
                            ...
                            <input name="fa_code_close" type="hidden" value="<?php  echo $fa_code; ?>">
                            <input name="fa_status_close" type="hidden" value="Close">
