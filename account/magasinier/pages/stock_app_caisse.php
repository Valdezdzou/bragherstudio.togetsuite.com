    ...
    <div id="appCapsule" class="extra-header-active">
        ...
        <form action="../functions/stock_app_caisse.func.php" method="post">
                    ...
                    <div class="section full mt-1">
                        <ul class="listview image-listview">
                            ...
                            ?>
                                ...
                                <li>
                                    <div class="item">
                                        <div class="in">
                                            ...
                                            <span class="badge">
                                                <input type="text" name="stc_quantite[]" style="width:30px;border:none" 
                                                      value="<?php  echo $row['stc_quantite']; ?>">
                                                <input name="stc_quantite_add[]" type="number" min="0" style="width: 50px;" 
                                                        max="<?php echo $row['st_quantite']; ?>" 
                                ...
                                <input name="stc_quantite_vente[]" type="hidden" value="">
            ...
            <div class="form-button-group">
                ...
                <input type="hidden" name="stc_date" value="<?php echo date("Y/m/d"); ?>">
                ...
                <div class="fab-button animate bottom-right dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <button name="save" type="submit" class="dropdown-item" href="#">
                            <ion-icon name="add-outline"></ion-icon>
                            <p>Ajouter les boissons au comptoir</p>
                        </button>
                    </div>
                </div>
                <!-- * bottom left -->
