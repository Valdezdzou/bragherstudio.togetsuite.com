            ...
            <div class="tab-content mt-1">
                        ...
                        <ul class="listview image-listview">
                            ...
                            <?php
                                $sqlSelect = "SELECT * FROM tsb_produits,tsb_historique_stocks
                                 where pr_categorie='Alcoolisé' and tsb_produits.pr_id=tsb_historique_stocks.pr_id_fk and st_quantite!=0 and st_status='comptoir' and st_date='$date'
                                 ";
                ...
                <div class="tab-pane fade" id="videos" role="tabpanel">
                    ...
                    <div class="section full mt-1">
                        <ul class="listview image-listview">
                            <?php
                                $sqlSelect = "SELECT * FROM tsb_produits,tsb_historique_stocks where pr_categorie='Non alcoolisé' and tsb_produits.pr_id=tsb_historique_stocks.pr_id_fk and st_quantite!=0 and st_status = 'comptoir' and st_date='$date' ";
                                $result = $bdd->selectEtu($sqlSelect);
                                if (! empty($result)) {
                ...
                <div class="tab-pane fade" id="sounds" role="tabpanel">
                    ...
                    <div class="section full mt-1">
                        <ul class="listview image-listview">
                            <?php
                                $sqlSelect = "SELECT * FROM tsb_produits, tsb_historique_stocks  where pr_categorie!='Alcoolisé' and pr_categorie!='Non alcoolisé' and tsb_produits.pr_id=tsb_historique_stocks.pr_id_fk and st_quantite!=0 and st_status = 'comptoir' and st_date='$date' ";
                                $result = $bdd->selectEtu($sqlSelect);
                                if (! empty($result)) {
