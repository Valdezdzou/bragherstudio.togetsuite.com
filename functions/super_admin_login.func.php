<?php 
    ...
    if (isset($_POST['save'])) {
        ...
        $sql ="SELECT us_phone,us_password FROM tsb_superAdmin WHERE us_phone=:us_phone and us_password=:us_password";
        ...
        if($result->us_phone==$us_phone and $result->us_password==$us_password){
