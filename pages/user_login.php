...
<body class="bg-white">
    ...
    <div id="appCapsule" class="pt-0">
        ...
        <div class="login-form mt-1">
            <div class="section">
                <img src="../assets/img/login.svg" alt="image" class="form-image">
            </div>
            ...
            <div class="section mt-1 mb-5">
                <form method="post" action="../functions/user_login.func.php">
                    ...
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <select name="us_type" class="form-control form-select" id="city5" required>
                                <option value="">Type de compte</option>
                                <option value="Admin">Administration</option>
                                <option value="Caisse">Caisse</option>
                                <option value="Service">Service</option>
                                <option value="Service">Magasinier</option>
                            </select>
                        </div>
                    </div>
