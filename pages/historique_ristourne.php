    ...
    <body class="bg-white" onload="updateData()">
        ...
        <div id="appCapsule">
            ...
            <div class="header-large-title">
                <h1 class="title">Toutes les ristournes</h1>
            </div>

            <form action="" method="post" id="Filter_fact">
                <div class="listview-title mt-2">ristournes par date d'approvisionnement  
                    <span> 
                        <label for="annee">Sélectionnez une année :</label>
                        <input type="number" id="annee" name="annee" min="2023" value="<?php echo date('Y'); ?>">

                    <script>
                        let input_annee = document.getElementById("annee");

                        input_annee.addEventListener("input", function() {
                        // Récupérer la valeur saisie dans le champ d'entrée
                        let annee = input_annee.value;
                    
                        // Appeler la fonction updateData() avec la valeur saisie comme argument
                        updateData();
                        });
                        ...
                        function updateData() {
                            ...
                            xhttp.open("GET", "../functions/get_ristournes.php?date=" + annee, true);
                            xhttp.send();
                        }
                    </script>
                    </span> 
