...
<body class="bg-white">
    ...
    <div id="appCapsule">
        ...
        <div class="header-large-title">
            <h1 class="title">Fournisseurs</h1>
        </div>


        <div class="listview-title mt-2">Tous les fournisseurs</div>
            ...
            <li>
                <a href="#" class="item">
                    <div class="imageWrapper">
                        <ion-icon name="bus-outline" class="image"></ion-icon>
                    </div>
                    <div class="in">
                        <div>
                            <?php  echo $row['fo_name']; ?>
                            <div class="text-muted"><?php  echo $row['fo_contact']; ?></div>
                        </div>
                        <span class="badge badge-primary"><?php  echo $row['fo_ville']; ?></span> 
                    </div>
                </a>
            </li>
